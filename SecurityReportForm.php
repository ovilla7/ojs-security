...
/**
 * @file plugins/reports/security/SecurityReportForm.inc.php
 *
...
class SecurityReportForm extends Form {

	/** @var int Associated context ID */
	private $_contextId;

	/** @var SecurityPlugin plugin */
	private $_plugin;

	/**
	 * Constructor
	 * @param $plugin SecurityPlugin plugin
	...
	function __construct($plugin, $contextId) {
		...
		parent::__construct($plugin->getTemplateResource('reportForm.tpl'));
	...
	function readInputData() {
		...
		if ($this->getData('displayItems') == 'recent') {
			$this->addCheck(new FormValidator($this, 'recentItems', 'required', 'plugins.reports.security.settings.recentItemsRequired'));
		}
